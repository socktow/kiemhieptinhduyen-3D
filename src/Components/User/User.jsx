...
const User = () => {
  ...
  const handleOptionClick = (option, e) => {
    ...
    if (
      !["Thông Tin Tổng Thể", "Thay Đổi Password", "Thay Đổi Email"].includes(
        option
      )
    ) {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-gray-100">
      ...
      <div className="w-full lg:w-1/4 bg-gray-800 text-white p-5">
        ...
        <ul>
          <li
            className={`text-2xl cursor-pointer p-2 mb-2 hover:bg-gray-700 rounded ${
              selectedOption === "Thông Tin Tổng Thể" ? "bg-gray-600" : ""
            }`}
            onClick={() => {
              ...
              <ul className="ml-4 mt-2">
                <li
                  className={`text-2xl cursor-pointer p-2 hover:bg-gray-700 rounded ${
                    selectedOption === "Thay Đổi Password" ? "bg-gray-600" : ""
                  }`}
                ...
                <li
                  className={`text-2xl cursor-pointer p-2 hover:bg-gray-700 rounded ${
                    selectedOption === "Thay Đổi Email" ? "bg-gray-600" : ""
                  }`}
          ...
          <li
            className={`text-2xl cursor-pointer p-2 mb-2 hover:bg-gray-700 rounded ${
              selectedOption === "GiftCode" ? "bg-gray-600" : ""
            }`}
          ...
          <li
            className={`text-2xl cursor-pointer p-2 mb-2 hover:bg-gray-700 rounded ${
              selectedOption === "Đổi KNB" ? "bg-gray-600" : ""
            }`}
          ...
          <li
            className={`text-2xl cursor-pointer p-2 mb-2 hover:bg-gray-700 rounded ${
              selectedOption === "Mốc Nạp" ? "bg-gray-600" : ""
            }`}
